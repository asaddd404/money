...
export const TeacherLeaderboardsPage = () => <div className="space-y-3"><PageHeader title="Group leaderboard" /><p className="rounded-xl border p-4 text-sm text-muted-foreground">Use student leaderboard analytics scoped for teacher groups.</p></div>;
